    ...
    <div class="main_full">
        <div class="layui-col-md12">
            ...
            <div class="fb-main-table">
                <form class="layui-form" action="<?php echo e(guard_url('shop')); ?>" method="POST" lay-filter="fb-form">
                    <div class="layui-form-item">
                        <label class="layui-form-label"><?php echo e(trans('shop.label.shop_name')); ?></label>
                        <div class="layui-input-inline">
                            <input type="text" name="shop_name" lay-verify="required" autocomplete="off" placeholder="请输入<?php echo e(trans('shop.label.shop_name')); ?>" class="layui-input" >
                        </div>
                    </div>
                    <div class="layui-form-item">
                    ...
                    <div class="layui-form-item">
                        ...
                        <div class="layui-input-inline">
                            <input type="text" name="business_time" lay-verify="required" autocomplete="off" placeholder="请输入<?php echo e(trans('shop.label.business_time')); ?>" class="layui-input" id="business_time">
                        </div>
                    </div>
