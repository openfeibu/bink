            ...
            <div class="fb-main-table">
                <form class="layui-form" action="<?php echo e(guard_url('setting/updateCompany')); ?>" method="post" lay-filter="fb-form">
                    ...
                    <div class="layui-form-item">
                        ...
                        <div class="layui-input-inline">
                            <input type="text" name="apply_shop_url" autocomplete="off" placeholder="请输入登记门店信息链接" class="layui-input" value="<?php echo e($company['apply_shop_url']); ?>">
                        </div>
                    </div>
                    <div class="layui-form-item">
                        <label class="layui-form-label">申请本地代理链接</label>
                        <div class="layui-input-inline">
                            <input type="text" name="apply_distributor_url"  autocomplete="off" placeholder="请输入申请本地代理链接" class="layui-input" value="<?php echo e($company['apply_distributor_url']); ?>">
                        </div>
                    </div>
                    ...
                    <div class="layui-form-item">
                        ...
                        <div class="layui-input-inline">
                            <input type="text" name="copyright" lay-verify="address" autocomplete="off" placeholder="请输入底部版权" class="layui-input" value="<?php echo e($company['copyright']); ?>">
                        </div>
                    </div>
