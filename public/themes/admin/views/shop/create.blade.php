            ...
            <div class="fb-main-table">
                <form class="layui-form" action="{{guard_url('shop')}}" method="POST" lay-filter="fb-form">
                    ...
                    <div class="layui-form-item">
                        ...
                        <div class="layui-input-block">
                            ...
                            @foreach($categories as $key => $category)
                                <input type="checkbox" name="categories[]" value="{{ $category->id }}" title="{{ $category->name }}" @if($category->type == 'system') checked @endif >
                                <?php $i++ ?>
                            @endforeach
                        </div>
                    </div>
                    ...
                    <div class="layui-form-item">
                        ...
                        <div class="layui-input-inline">
                            <input type="text" name="tel" autocomplete="off" placeholder="请输入{{ trans('shop.label.tel') }}" class="layui-input" value="">
                        </div>
                    </div>
