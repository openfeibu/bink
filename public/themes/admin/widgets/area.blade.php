<div class="layui-form-item level-high">
    ...
    <div class="layui-input-inline">
        <select name="province_code" lay-filter="province" id="s_province" lay-verify="required"  lay-search>
    ...
    <div class="layui-input-inline">
        <select name="city_code" lay-filter="city" id="s_city" lay-search>
            <option value="">{{ trans('app.select_city') }}</option>
        </select>
    </div>
    <div class="layui-input-inline">
        <select name="county_code" lay-filter="county" id="s_county" lay-search>
