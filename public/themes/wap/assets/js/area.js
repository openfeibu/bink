    ...
    $.fn.getArea = function (options) {
        ...
        $(this).each(function () {
            ...
            $(this).on(params.eventInpFocus, function () {
				...
				setTimeout(function(){
					$(params.areaMask).find(".area-larger-main").css("bottom",0)
				},50)
            ...
            $(params.elePage).on(params.eventClick, params.confirmArea, function () {
                ...
                $("body").removeAttr("style");$("body").removeAttr("style");$(params.areaMask).fadeOut(200);
            ...
            $(params.elePage).on(params.eventClick, '#areaScrollMask', function (e) {
                if (e.target.id === 'areaScrollMask'){ $("body").removeAttr("style");$("body").removeAttr("style");$(params.areaMask).fadeOut(200);$(params.areaMask).find(".area-larger-main").css({"bottom":"-100%"})}
            });
            // 手指开始触摸
            ...
            function getAreaContent() {
                var html =  '<div class="area-larger-mask" id="areaScrollMask">'+
                            '<div class="area-larger-main" style="bottom:-100%">'+
